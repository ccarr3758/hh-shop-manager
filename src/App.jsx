...
>
  ...
  <PerformanceCenter jobs={state.jobs} ctx={ctx} metrics={metrics} />
        ...
        {view === "Mobile Manager" && (
          <MobileManager jobs={state.jobs} ctx={ctx} reload={loadAll} setEditingJob={setEditingJob} />
        )}
        ...
        {view === "Production Log" && <ProductionLog jobs={state.jobs} ctx={ctx} reload={loadAll} setEditingJob={setEditingJob} />}
...
function MobileManager({ jobs, ctx, reload, setEditingJob }) {
