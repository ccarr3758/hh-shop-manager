...
async function fetchIcsFeedText(url) {
  ...
  for (const attempt of attempts) {
    try {
      ...
      if (!/BEGIN:VCALENDAR|BEGIN:VEVENT/i.test(text)) throw new Error("That URL did not return a valid ICS calendar.");
      return text;
    } catch (err) {
  ...
  throw new Error(`Unable to load the ICS feed. ${lastError} If this keeps happening, the Outlook feed may block browser access.`);
}
